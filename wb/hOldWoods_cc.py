...
wbt.work_dir = "/Volumes/LaCie/GEOG0310/wbt_pySpace/hOldWoods/data"
...
oldTrees = "/Volumes/LaCie/GEOG0310/wbt_pySpace/middData/oldTreeCounts_12092021.tif"
treeBinary = "/Volumes/LaCie/GEOG0310/wbt_pySpace/middData/treeBinary_12122021.tif"
imageConifers = "/Volumes/LaCie/GEOG0310/wbt_pySpace/middData/treeConifers_12122021.tif"
...
wbt.reclass(
    ...
    output = "02_reclassify_otCount.tif",
    reclass_vals = "0;1;0;2;1;3",
    assign_mode=True
)
...
# QUESTION: Do we need this? I thought we removed points
# that do not overlap tree canopy BEFORE we started removing
# them manually as part of digitizing process?

wbt.multiply(
    input1 = "02_reclassify_otCount.tif",
    input2 = "01_treeBinary_noDataZero.tif",
    output = "03_multiply_otCount_treeBinary.tif"
)
